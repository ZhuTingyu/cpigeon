...
import com.cpigeon.app.utils.video.filter.RotationOESFilter;
...
import com.cpigeon.app.utils.video.media.VideoInfo;
...
//        mShow.setMatrix(OM);
        ...
        waterMarkFilter.setWaterMark(BitmapFactory.decodeResource(res, R.mipmap.logo));
