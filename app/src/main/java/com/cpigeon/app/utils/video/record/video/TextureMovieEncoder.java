...
package com.cpigeon.app.utils.video.record.video;
...
import com.cpigeon.app.utils.video.gpufilter.basefilter.GPUImageFilter;
import com.cpigeon.app.utils.video.gpufilter.basefilter.MagicCameraInputFilter;
import com.cpigeon.app.utils.video.record.gles.EglCore;
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(MyApp.getInstance().getResources());
