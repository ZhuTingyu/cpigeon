package com.cpigeon.app.utils.video.camera;
...
public class CameraController implements ICamera {
    ...
    public void onFocus(Point point, Camera.AutoFocusCallback callback) {
        ...
        //再次进行转换
        point.x = (int) (((float) point.x) / ScreenTool.getScreenWidth(MyApp.getInstance().getBaseContext()) * 2000 - 1000);
        point.y = (int) (((float) point.y) / ScreenTool.getScreenHeight(MyApp.getInstance().getBaseContext()) * 2000 - 1000);
