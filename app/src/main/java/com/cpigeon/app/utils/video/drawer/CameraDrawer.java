package com.cpigeon.app.utils.video.drawer;
...
import com.cpigeon.app.utils.video.GetBitmap;
import com.cpigeon.app.utils.video.filter.AFilter;
import com.cpigeon.app.utils.video.filter.CameraFilter;
import com.cpigeon.app.utils.video.filter.GroupFilter;
import com.cpigeon.app.utils.video.filter.NoFilter;
import com.cpigeon.app.utils.video.filter.ProcessFilter;
import com.cpigeon.app.utils.video.filter.WaterMarkFilter;
import com.cpigeon.app.utils.video.gpufilter.filter.MagicBeautyFilter;
import com.cpigeon.app.utils.video.record.video.TextureMovieEncoder;
import com.cpigeon.app.utils.video.utils.EasyGlUtils;
import com.cpigeon.app.utils.video.utils.MatrixUtils;
...
//        filter.setMatrix(OM);
     ...
     * @param eglConfig
     */
    private String TAG = "CameraDrawer";
