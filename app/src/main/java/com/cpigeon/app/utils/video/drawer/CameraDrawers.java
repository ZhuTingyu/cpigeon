package com.cpigeon.app.utils.video.drawer;//package com.cpigeon.cpigeonhelper.video.drawer;
//
...
//import com.cpigeon.cpigeonhelper.video.filter.AFilter;
//import com.cpigeon.cpigeonhelper.video.filter.CameraFilter;
//import com.cpigeon.cpigeonhelper.video.filter.GroupFilter;
//import com.cpigeon.cpigeonhelper.video.filter.NoFilter;
//import com.cpigeon.cpigeonhelper.video.filter.ProcessFilter;
//import com.cpigeon.cpigeonhelper.video.filter.WaterMarkFilter;
//import com.cpigeon.cpigeonhelper.video.gpufilter.filter.MagicBeautyFilter;
//import com.cpigeon.cpigeonhelper.video.record.video.TextureMovieEncoder;
//import com.cpigeon.cpigeonhelper.video.utils.EasyGlUtils;
//import com.cpigeon.cpigeonhelper.video.utils.MatrixUtils;
//
...
// */
//
//public class CameraDrawers implements GLSurfaceView.Renderer {
//
//    private float[] OM;
//    /**
//     * 显示画面的filter
...
//     * 水印的宽高
//     */
//    private int waterWidth = 0, waterHeight = 0;
//
...
//
//
//    public CameraDrawers(Resources resources) {
//
...
//            waterMarkFilter.setPosition(20, mPreviewHeight - bitmap.getHeight() - 20, 0, 0);
