...
public class HideMessageListPre extends BasePresenter{
    ...
    public void getHideMessage(Consumer<List<String>> consumer){
        submitRequestThrowError(CircleModel.hideMessageList(userId, page, 10).map());
    }
